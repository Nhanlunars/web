...
this.props.getUserStart();
    ...
    render() {
        ...
        let { user_id, title, message, is_read } = this.state;
        return (
                ...
                <div className='notification-redux-body'>
                    <div className='container'>
                        <div className='row'>
                            ...
                            <div className='col-3'>
                                <label><FormattedMessage id='is_read' /></label>
                                <input className='form-control' type="text"
                                    value={is_read}
                                    onChange={(event) => { this.onChangeInput(event, 'is_read') }}
                                />
                            </div>
                            ...
                            <div className='col-12 mb-5'>
                                <TableManageNotification
                                    handleEditNotificationFromParentKey={this.handleEditNotificationFromParent}
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        createNewNotification: (data) => dispatch(actions.createNewNotification(data)),
