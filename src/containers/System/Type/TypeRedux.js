            ...
            <div className="row">
              ...
              <div className="col-3">
                ...
                <input
                  ...
                  value={type_name}
                  onChange={(event) => {
                    this.onChangeInput(event, "type_name");
                  }}
                />
              </div>
              <div className="col-3">
                ...
                <input
                  ...
                  value={default_price}
                  onChange={(event) => {
                    this.onChangeInput(event, "default_price");
                  }}
                />
              </div>
              <div className="col-3">
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    createNewTypeRedux: (data) => dispatch(actions.createNewType(data)),
    createNewType: (data) => dispatch(actions.createNewTypee(data)),
