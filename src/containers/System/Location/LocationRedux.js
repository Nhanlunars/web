...
class LocationRedux extends Component {
  ...
  handlesaveLocation = () => {
    ...
    if (userInfo.roleId === USER_ROLE.ADMIN) {
      if (action === CRUD_ACTIONS.CREATE) {
        ...
        this.props.createNewLocationRedux({
  ...
  render() {
    ...
    let { userInfo } = this.props;
    let { location_name, user_id, city, address, ward, district, lng, lat } =
      this.state;
    return (
            ...
            <div className="row">
              ...
              <div className="col-3">
                ...
                <input
                  ...
                  value={location_name}
                  onChange={(event) => {
                    this.onChangeInput(event, "location_name");
                  }}
                />
              </div>
              <div className="col-3">
              ...
              <div className="col-3">
                ...
                <input
                  ...
                  value={district}
                  onChange={(event) => {
                    this.onChangeInput(event, "district");
                  }}
                />
              </div>
              <div className="col-3">
              ...
              <div className="col-12 mb-5">
                <TableManageLocation
                  handleEditLocationFromParentKey={
                    this.handleEditLocationFromParent
                  }
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    createNewLocationRedux: (data) => dispatch(actions.createNewLocation(data)),
    createNewLocation: (data) => dispatch(actions.createNewLocationn(data)),
